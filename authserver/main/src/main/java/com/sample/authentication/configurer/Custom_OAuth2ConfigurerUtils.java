package com.sample.authentication.configurer;

import com.nimbusds.jose.jwk.source.JWKSource;
import com.nimbusds.jose.proc.SecurityContext;
import com.sample.authentication.Custom_DefaultOAuth2TokenCustomizers;
...
public class Custom_OAuth2ConfigurerUtils {
    private Custom_OAuth2ConfigurerUtils() {
    ...
    private static OAuth2TokenCustomizer<JwtEncodingContext> getJwtCustomizer(HttpSecurity httpSecurity) {
        OAuth2TokenCustomizer<JwtEncodingContext> defaultJwtCustomizer = Custom_DefaultOAuth2TokenCustomizers.jwtCustomizer();
        ...
        return jwtCustomizer == null ? defaultJwtCustomizer : (context) -> {
    ...
    private static OAuth2TokenCustomizer<OAuth2TokenClaimsContext> getAccessTokenCustomizer(HttpSecurity httpSecurity) {
        OAuth2TokenCustomizer<OAuth2TokenClaimsContext> defaultAccessTokenCustomizer = Custom_DefaultOAuth2TokenCustomizers.accessTokenCustomizer();
        ...
        return accessTokenCustomizer == null ? defaultAccessTokenCustomizer : (context) -> {
